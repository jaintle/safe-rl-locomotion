...
# ==========================
# Reproduce the Hopper-v4 benchmark at 1 000 000 environment steps.
#
...
#   runs/ppo_hopper_v4_t025_seed{S}_1m
#   runs/cppo_hopper_v4_t025_limit80_seed{S}_1m
#
# Usage:
#   source .venv/bin/activate
#   bash scripts/reproduce_hopper_v4_1m.sh
#
# Expected wall time (CPU): ~6–12 h total (6 runs × ~60–120 min each).
